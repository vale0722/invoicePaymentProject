...
Route::patch('/invoice/annul/{invoice}', 'InvoiceController@annulate')->name('invoice.annulate');
Route::get('/invoice/annul/{invoice}', 'InvoiceController@annulateView')->name('invoice.annulate.view');
Route::patch('/invoice/annul/cancel/{invoice}', 'InvoiceController@annulateCancel')->name('invoice.annulate.cancel');
